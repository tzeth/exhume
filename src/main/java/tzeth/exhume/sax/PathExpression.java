...
public final class PathExpression {
    ...
    public PathExpression(String expression) {
        ...
        String toSplit = this.absolute ? expression.substring(1) : expression;
        ...
        checkArgument(this.particles.get(this.particles.size() - 1) instanceof Name,
                "The expression must end with a name");
